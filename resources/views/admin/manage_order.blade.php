          ...
          <tbody>
            @foreach($all_order as $key => $item)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.view_order',['id' => $item->order_id])}}" class="active styling-edit" ui-toggle-class="">
                            <i class="fa fa-pencil-square-o text-success text-active"></i>
                        </a>
                        <a onclick="return confirm('Are you sure to delete this category ?')" href="{{ URL::to('admin.delete_order',['id' => $item->order_id])}}" class="active styling-delete" ui-toggle-class="">
